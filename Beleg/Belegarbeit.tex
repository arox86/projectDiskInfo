...
Das hier gezeigte Domänenmodell stellt die Funktion vor der Änderung des Programmes da.

\includegraphics [width=1\textwidth]{"Bilder/DomaenenModell_0"}  \label{fig:gull}
