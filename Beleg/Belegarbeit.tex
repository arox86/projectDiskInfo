...
\section{Einführung}
Im Rahmen der Lehrveranstaltung Softwaretechnik, des Studiengangs Computer Engineering der HTW-Berlin haben die Studenten die Aufgabe eine Open Source-Software nach bestimmten Vorgaben und  eigenen Vorstellungen abzuändern. Eine objektorientierte Programmiersprache und eine gewissen
Anzahl an Grundfunktionalität sowie Klassenanzahl, sind Vorrausetzung bei Auswahl der Software.
Zudem soll eine Belegarbeit parallel zu den Änderungen im Source Code angefertigt werden, dies ist die Motivation dieser Ausarbeitung.
...
4. Das Programm zeigt einen Graph mit gewählten Datenreihen an.
\\\\
...
\begin{figure}[H]
	\centering
	\includegraphics [width=1.1\textwidth]{Bilder/DomaenenModell_1}	
