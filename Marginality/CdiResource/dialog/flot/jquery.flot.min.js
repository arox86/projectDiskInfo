    ...
    function Plot(target_, data_, options_) {
        ...
        function drawSeriesPoints(series) {
            ...
            if (lw > 0 && sw > 0) {
                ...
                ctx.lineWidth = w;
                ctx.strokeStyle = "rgba(0,0,0,0.1)";
                plotPoints(series.datapoints, radius, null, w + w / 2, 2 * Math.PI, series.xaxis, series.yaxis);
                ctx.strokeStyle = "rgba(0,0,0,0.2)";
                plotPoints(series.datapoints, radius, null, w / 2, 2 * Math.PI, series.xaxis, series.yaxis);
            }
            ctx.lineWidth = lw;
            ctx.strokeStyle = series.color;
        ...
        function insertLegend() {
            ...
            for (i = 0; i < series.length; ++i) {
                ...
                fragments.push('<td class="legendColorBox"><div style="border:1px solid ' + options.legend.labelBoxBorderColor + ';padding:1px"><div style="width:4px;height:0;border:5px solid ' + series[i].color + ';overflow:hidden"></div></div></td>' + '<td class="legendLabel">' + label + '</td>');
            }
            if (rowStarted)
                fragments.push('</tr>');
        ...
        function onMouseMove(ev) {
            ...
            if (options.grid.hoverable)
                triggerClickHoverEvent("plothover", lastMousePos, function (s) {
        ...
        function drawBarHighlight(series, point) {
            ...
            var barLeft = series.bars.align == "left" ? 0 : -series.bars.barWidth / 2;
            drawBar(point[0], point[1], barLeft, barLeft + series.bars.barWidth, 0, function () {
                return fillStyle;
